...
`NOTE:` items throughout the file.
...
require('lazy').setup({
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        ...
        local ignore_filetypes = { 'rb', 'rake' }
  ...
  -- Fuzzy Finder (files, lsp, etc)
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>ld', builtin.lsp_document_symbols, { desc = '[D]ocument [S]ymbols' })
      vim.keymap.set('n', '<leader>lw', builtin.lsp_dynamic_workspace_symbols, { desc = '[W]orkspace [S]ymbols' })
